...
export function ExpatNewsSection() {
  ...
  return (
    <section className={styles.section} aria-labelledby="expat-news-title">
      <Container>
        <header className={styles.heading}><span>متابعة مستمرة</span><h2 id="expat-news-title">أخبـــار الــوافــديـن</h2><p>كل ما يهم الطالب الوافد من أخبار ومستجدات وفرص.</p></header>
