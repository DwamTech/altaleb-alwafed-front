...
export function GallerySection() {
  return (
    <section className={styles.section} aria-labelledby="gallery-title">
      <Container>
        <header className={styles.heading}><div><span>لحظات لا تُنسى</span><h2 id="gallery-title">صور من الجمعية</h2></div><p>مشاهد من فعالياتنا ومجتمعنا الذي يجمع الطلاب من ثقافات مختلفة.</p></header>
